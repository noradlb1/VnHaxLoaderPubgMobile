...
void CustomImGUIStyle()
{
	...
	//Title Bar Color============================================================
	style.Colors[ImGuiCol_TitleBg] = ImColor(0, 150, 255, 250);
	style.Colors[ImGuiCol_TitleBgActive] = ImColor(0, 110, 255, 250);
	...
	style.Colors[ImGuiCol_SliderGrab] = ImColor(170, 240, 255, 250);
	style.Colors[ImGuiCol_SliderGrabActive] = ImColor(170, 240, 255, 250);
	...
	colors[ImGuiCol_SliderGrabActive] = ImColor(170, 240, 255, 250);

	//Login Menu + Main Menu Button Color============================================================
	style.Colors[ImGuiCol_Button] = ImColor(0, 100, 160, 250);
	style.Colors[ImGuiCol_ButtonHovered] = ImColor(0, 60, 160, 250);
	style.Colors[ImGuiCol_ButtonActive] = ImColor(0, 40, 90, 250);
	...
	style.Colors[ImGuiCol_Tab] = ImColor(0, 40, 90, 255);
	style.Colors[ImGuiCol_TabHovered] = ImColor(0, 80, 160, 255);
	style.Colors[ImGuiCol_TabActive] = ImColor(0, 100, 230, 255);
...
int main()
{
	...
	/*printf("Welcome to Back (SubahanAllah HACK)\n");
	Sleep(1000);
	...
	//printf("Welcome to Back (PABLO HACK)\n");
	//Sleep(50);
	//std::cout << "\n ";
	std::cout<< "\n";
	Sleep(20);
